...
class CategoriesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.pages.products.categories.create', compact('categories'));
    }
    ...
    {   
        ...
        $category->slug=getUniqueValue('Category', 'slug', [2, 2],$request->name,false);
        ...
        $lan_key=env('DEFAULT_LANGUAGE') ?? 'en';

        $categoryLocalization = CategoryLocalization::firstOrNew(['lang_key' => $lan_key, 'category_id' => $category->id]);
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('backend.pages.products.categories.edit', compact('category', 'categories', 'lang_key'));
    }
    ...
    public function update(Request $request)
    {
        ...
        $categoryLocalization = CategoryLocalization::firstOrNew(['lang_key' => $lang_key, 'category_id' => $category->id]);
