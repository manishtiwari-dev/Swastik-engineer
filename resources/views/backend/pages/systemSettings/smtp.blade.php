                    ...
                    <div class="card mb-4" id="section-1">
                        <div class="card-body">
                            ...
                            <div id="smtp">
                                ...
                                <div class="mb-4">
                                    <input type="hidden" name="types[]" value="ADMIN_MAIL_ADDRESS">
                                    <label for="ADMIN_MAIL_ADDRESS"
                                        class="form-label">{{ localize('Admin Mail Address') }}</label>
                                    <input type="text" name="ADMIN_MAIL_ADDRESS" id="ADMIN_MAIL_ADDRESS"
                                        class="form-control" placeholder="{{ localize('Type admin mail address') }}"
                                        required value="{{ env('ADMIN_MAIL_ADDRESS') }}">
                                </div>

                                <div class="mb-4">
                                    <input type="hidden" name="types[]" value="ADMIN_NAME">
                                    <label for="ADMIN_NAME"
                                        class="form-label">{{ localize('Admin Name') }}</label>
                                    <input type="text" name="ADMIN_NAME" id="ADMIN_NAME"
                                        class="form-control" placeholder="{{ localize('Type admin name') }}"
                                        required value="{{ env('ADMIN_NAME') }}">
                                </div>
