                    ...
                    <div class="card mb-4" id="section-1">
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-control select2" name="categories_id[]" class="w-100" multiple="multiple"
                                    data-toggle="select2" data-placeholder="{{ localize('Select categories..') }}">
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}" {{ $brandCategories->contains($category->id) ? 'selected' : 'hii' }}>
                            ...
                            <div class="mb-4">
                                ...
                                <input class="form-control" type="number" id="sorting_order_level"
                                    ...
                                    name="sorting_order_level" value="{{ $brand->sorting_order_level }}">
                            </div>
