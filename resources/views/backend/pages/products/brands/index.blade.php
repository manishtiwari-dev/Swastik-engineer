                                ...
                                <tbody>
                                    ...
                                    @foreach ($brands as $key => $brand)
                                        <tr>
                                            ...
                                            <td>{{ $brand->sorting_order_level }}</td>
                                            <td>
                                                @can('publish_brands')
                    ...
                    <form action="{{ route('admin.brands.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="card mb-4" id="section-2">
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    <label for="categories_id" class="form-label">{{ localize('Base Category') }}</label>
                                    <select class="form-control select2" name="categories_id[]" class="w-100" multiple
                                ...
                                <div class="mb-4">
                                    <label for="sorting_order_level" class="form-label">{{ localize('Sorting Priority Number') }}</label>
                                    <input class="form-control" type="number" id="sorting_order_level" placeholder="{{ localize('Type sorting priority number') }}" name="sorting_order_level">
                                </div>
