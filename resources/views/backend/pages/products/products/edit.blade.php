    ...
    <div class="container">
        ...
        <div class="row mb-4 g-4">
            ...
            <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                <form action="{{ route('admin.products.update') }}" enctype="multipart/form-data" method="POST" class="pb-650" id="product-form">
                    @csrf

                    <input type="hidden" name="id" value="{{ $product->id }}">
                    <input type="hidden" name="lang_key" value="{{ $lang_key ?? 'en' }}">
                        ...
                        <div class="card mb-4" id="section-3">
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <a target="_blank" href="{{asset('storage/'.$product->attachment)}}" >Download Attachment</a>
                                    @endif
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="variationvalues">
                                                    @php
                                                        $variation_values = \App\Models\VariationValue::
