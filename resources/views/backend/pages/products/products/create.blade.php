    ...
    <div class="container">
        ...
        <div class="row mb-4 g-4">
            ...
            <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="pb-650" id="product-form">
                    @csrf
                    ...
                    <div class="card mb-4" id="section-3">
                        <div class="card-body">
                            <h5 class="mb-4">{{ localize('Product Attachment') }}</h5>
                            <div class="mb-4">
                                <input class="form-control" type="file" name="product_attachment" id="formFile">
                            </div>
                        </div>
                    </div>
                    <!-- Attachment End -->
                    ...
                    <div class="card mb-4" id="section-3">
                        <div class="card-body">
                            <h5 class="mb-4">{{ localize('AddOn-Product') }}</h5>
                            <div class="mb-4">
                                <select class="select2 form-control" multiple="multiple"
                                    data-placeholder="{{ localize('Select AddOn-Products') }}" name="addon_products_ids[]">
                                    @foreach ($addOnProducts as $item)
                                        <option value="{{ $item->id }}">{{ $item->collectLocalization('name') }} gr</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tt-vertical-step">
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    <a href="#section-9">{{ localize('Product Status') }}</a>
                                </li>
                                <li>
