...
@section('title')
    {{ localize('AddOn-Products') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                ...
                <div class="card tt-page-header">
                    <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                        <div class="tt-page-title">
                            <h2 class="h5 mb-lg-0">{{ localize('AddOn Products') }}</h2>
                        </div>
                        <div class="tt-action">
                            @can('add_products')
                                <a href="{{ route('admin.addon-products.create') }}" class="btn btn-primary"><i
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end shadow">
                                                @can('edit_products')
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.addon-products.edit', ['id' => $product->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
...
@push('scripts')
    <script>
        ...
        function updatePublishedStatus(el) {
            ...
            $.post('{{ route('admin.addon-products.updatePublishedStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    status: status
                },
