    ...
    <div class="container">
                ...
                <div class="card tt-page-header">
                    <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                        <div class="tt-page-title">
                            <h2 class="h5 mb-lg-0">{{ localize('Update Certificate') }}</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mb-4 g-4">
            ...
            <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                ...
                <form action="{{ route('admin.appearance.homepage.updateCertificate') }}" method="POST"
                    ...
                    @php
                        ...
                        if (!empty($certificates)) {
                            foreach ($certificates as $key => $thisSlider) {
                                if ($thisSlider->id == $id) {
                                    $slider = $thisSlider;
                                }
                            }
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="tt-image-drop rounded">
                                    <span class="fw-semibold">{{ localize('Choose Certificate Image') }}</span>
                                    <!-- choose media -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="tt-vertical-step">
                            <ul class="list-unstyled">
                                <li>
                                    <a href="#section-1" class="active">{{ localize('Update') }}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
