                ...
                <ul class="navbar-nav flex-row align-items-center tt-top-navbar">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('clear-cache') }}" class="nav-link" >
                            <i data-feather="battery-charging" class="me-2"></i>
                        </a>
                    </li>
                    ...
                    @can('contact_us_messages')
                        @php
                            $newEnquiryCount = \App\Models\ProductEnquiry::where('is_seen', 0)->count();
                        @endphp
                    @endcan
                    ...
                    <a class="nav-link position-relative tt-notification" href="#" role="button"
                        ...
                        @if ($newMsgCount > 0 || $newOrdersCount > 0 || $newEnquiryCount > 0)
                                        ...
                                        @if ($newEnquiryCount > 0)
                                            <div class="p-3 position-relative border-bottom">
                                                <a href="{{ route('admin.enquiries.index') }}"
                                                    ...
                                                    <h4 class="fs-md mb-0"><i data-feather="mail" width="18"
                                                            class="me-1 text-success"></i>
                                                        {{ localize('New Enquiry Message') }} ({{ $newEnquiryCount }})</h4>
                                                </a>
                                            </div>
                                        @endif
                                    @endcan
